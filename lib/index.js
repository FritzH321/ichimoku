...
var Ichimoku = function () {
    function Ichimoku(input) {
        ...
        this.generator = /*#__PURE__*/_regenerator2.default.mark(function _callee() {
            var result, tick, period, periodCounter, spanCounter, lagCounter, highs, lows, closes, spanAs, spanAsNoDis, spanBs, spanBsNoDis, conversionPeriodLow, conversionPeriodHigh, basePeriodLow, basePeriodHigh, spanbPeriodLow, spanbPeriodHigh, conversionLine, baseLine, spanA, spanANoDis, spanB, spanBNoDis, close;
                    ...
                    switch (_context.prev = _context.next) {
                        ...
                        case 19:
                            ...
                            if (periodCounter < period) {
                                ...
                                result = {
                                    conversion: parseFloat(conversionLine.toFixed(8)),
